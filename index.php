            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index.php">ArfBlog World!</a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><img src="img/menu.png" style="height:20px;width:25px" /><i data-feather="menu"></i></button>
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto mr-lg-5">
                                    ...
                                    <li class="nav-item dropdown no-caret">
                                        <a class="nav-link" href="<?php echo FRONT_SITE_PATH ?>backend/">Blogers</a>
                                    </li>
                                </ul>
                                <?php 
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-lg-10 text-center">
                                        ...
                                        <h1 class="page-header-title">Welcome to ArfBlog</h1>
                                        ...
                                        <form class="page-header-signup mb-2 mb-md-0" action="search.php" method="POST">
                                            <div class="form-row justify-content-center">
                                                <div class="col-lg-6 col-md-8">
                                                    <div class="form-group mr-0 mr-lg-2"><input class="form-control form-control-solid rounded-pill" name="search-keyword" type="text" placeholder="Search keyword..."/></div>
                                                </div>
        ...
        <img class="card-img-top" src="./img/<?php echo $post_image; ?>" alt="<?php echo $post_image; ?>" />
                    ...
                    <h5 class="card-title"><?php echo $post_title; ?></h5>
                      <p class="card-text"><?php echo $post_detail; ?></p>
                         ...
                         <?php
                                if ($post_count > $post_per_page) { ?>
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination pagination-blog justify-content-center">
                                            ...
                                            <?php    //previous page operation icon 
                                                if(isset($_GET['page'])) {
                                                    $prev = $_GET['page'] - 1;
                                                } else {
                                                    $prev = 0;
                                            ...
                                            <?php ///click the page and get number
                                                if (isset($_GET['page'])) {
                                                    $active = $_GET['page'];
                                                } else {
                                                    $active = 1;
                            ...
                            <div class="row">
                                  <?php 
                                  //because i want to show three post(limit o to 3)
                 ...
                 <div class="col-lg-4 col-md-6 mb-5">
                        ...
                        <div class="card-footer bg-transparent pt-0 pb-5">
                            <div class="badge badge-pill badge-light font-weight-normal px-3 py-2"><?php echo $total_posts; ?> Posts</div></div>
