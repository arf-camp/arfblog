            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            ...
                            $curr_page = basename(__FILE__).'?key='.$_GET['key'].'&cat_id='.$_GET['cat_id']; 
               ...
               <?php 
                        if(isset($_POST['search-keyword'])) {
                            $url =FRONT_SITE_PATH."/category-search.php?key=".$_POST['search-keyword']."&cat_id=".$_POST['category-id'];
                            header("Location: {$url}");
                        }
                    ?>
                            ...
                            <div class="container text-center">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="page-header-text">Total posts found: <?php echo $post_found; ?> on this category search </p>
                                    </div>
                                </div>
                            </div>
                        </div>
